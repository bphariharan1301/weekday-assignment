...
const JobList = () => {
    ...
    const filteredJobs = jobs.filter((job) => {
        return (
            (filters.minExp.length === 0 ||
                filters.minExp.includes(job.minExp)) &&
            (filters.companyName.length === 0 ||
                filters.companyName.includes(job.companyName)) &&
            (filters.location.length === 0 ||
                filters.location.includes(job.location)) &&
            (filters.minJdSalary.length === 0 ||
                filters.minJdSalary.includes(job.minJdSalary)) &&
            (filters.jobRole.length === 0 ||
                filters.jobRole.includes(job.jobRole)) &&
            (filters.salaryCurrencyCode.length === 0 ||
                filters.salaryCurrencyCode.includes(job.salaryCurrencyCode))
        );
    });
            ...
            >
                <Dropdown
                    ...
                    setSelectedValues={(selectedValues) =>
                        handleFilterChange("minExp", selectedValues)
                    }
                />
                <Dropdown
                    values={companyNames}
                    ...
                    setSelectedValues={(selectedValues) =>
                        handleFilterChange("companyName", selectedValues)
                    }
                />
                <Dropdown
                    values={locations}
                ...
                <Dropdown
                    ...
                    setSelectedValues={(selectedValues) =>
                        handleFilterChange("jobRole", selectedValues)
                    }
                />
                <Dropdown
                    values={currencies}
                    ...
                    setSelectedValues={(selectedValues) =>
                        handleFilterChange("salaryCurrencyCode", selectedValues)
                    }
                />
                <Dropdown
                    values={salaries}
                    ...
                    setSelectedValues={(selectedValues) =>
                        handleFilterChange("minJdSalary", selectedValues)
                    }
                />
            </div>
